  ...
  <>
    ...
    <div className="min-h-screen bg-gray-200 max-w-7xl mx-auto pt-20">
      ...
      <div className="container mx-auto py-8 px-5 md:px-0">
        ...
        <div className='mb-8 '>
          <h2 class="text-3xl font-bold mb-2">Skills e competenze</h2>
          <hr className="mb-2 h-[6px] bg-blue-400 w-32" />
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 text-gray-900">
            <div class="bg-white shadow rounded-lg p-6">
              <h3 class="text-lg font-bold mb-4">ReactJS</h3>
              <p class="px-4">
            ...
            <div class="bg-white shadow rounded-lg p-6">
              <h3 class="text-lg font-bold mb-4">TailwindCSS</h3>
              <p class="px-4">
            ...
            <div class="bg-white shadow rounded-lg p-6">
              <h3 class="text-lg font-bold mb-4">VueJS</h3>
              <p class="px-4">
            ...
            <div class="bg-white shadow rounded-lg p-6">
              <h3 class="text-lg font-bold mb-4">NodeJS</h3>
              <p className='px-4'>
            ...
            <div class="bg-white shadow rounded-lg p-6">
              <h3 class="text-lg font-bold mb-4">Test e Time Estimation</h3>
              <p className='px-4'>
            ...
            <div class="bg-white shadow rounded-lg p-6">
              <h3 class="text-lg font-bold mb-4">Altre Competenze</h3>
              <p className='px-4'>
        ...
        <div className='container mx-auto'>
          <div class="mb-8">
            <h2 class="text-3xl font-bold mb-2">Progetti</h2>
            <hr className="mb-2 h-[6px] bg-blue-400 w-32" />
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
              <a href="https://www.yoox.com" target="_blank" rel="noopener noreferrer">
                <div class="bg-white shadow rounded-lg overflow-hidden">
                  <img class="w-full" src={require('./assets/yoox-preview.webp')} alt="Anteprima yoox.it" className='object-cover h-64 w-full' />
                  <div class="p-4">
                    <h3 class="text-lg font-bold mb-2 truncate">Special Campaigns | Yoox.it (employee)</h3>
                  </div>
                </div>
              </a>
              <a href="https://www.enel.it" target="_blank" rel="noopener noreferrer">
                <div class="bg-white shadow rounded-lg overflow-hidden">
                  <img class="w-full" src={require('./assets/enel-preview.webp')} alt="Anteprima viveresenzalattosio.it" className='object-cover h-64 w-full' />
                  <div class="p-4">
                    <h3 class="text-lg font-bold mb-2 truncate">WebApp Gestione Reclami | enel.it (Consultant)</h3>
                  </div>
                </div>
              </a>
              <a href="https://www.deghi.it" target="_blank" rel="noopener noreferrer">
                <div class="bg-white shadow rounded-lg overflow-hidden">
                  <img src={require('./assets/deghi-preview.webp')} alt="Anteprima deghi.ti" className='object-cover h-64 w-full' />
                  <div class="p-4">
                    <h3 class="text-lg font-bold mb-2">E-commerce | Deghi.it (external)</h3>
                  </div>
                </div>
              </a>
              <a href="https://www.doveconviene.it" target="_blank" rel="noopener noreferrer">
                <div class="bg-white shadow rounded-lg overflow-hidden">
                  <img class="w-full" src={require('./assets/doveconviene-preview.webp')} alt="Anteprima doveconviene.it" className='object-cover h-64 w-full' />
                  <div class="p-4">
                    <h3 class="text-lg font-bold mb-2 truncate">Campaign Manager | doveconviene.it (employee)</h3>
                  </div>
                </div>
              </a>
              <a href="https://www.ingenico.com" target="_blank" rel="noopener noreferrer">
                <div class="bg-white shadow rounded-lg overflow-hidden">
                  <img class="w-full" src={require('./assets/ingenico-preview.webp')} alt="Anteprima doveconviene.it" className='object-cover h-64 w-full' />
                  <div class="p-4">
                    <h3 class="text-lg font-bold mb-2 truncate">Tickets App | ingenico.com (consultant)</h3>
                  </div>
                </div>
              </a>
              <a href="https://www.viveresenzalattosio.it" target="_blank" rel="noopener noreferrer">
                <div class="bg-white shadow rounded-lg overflow-hidden">
                  <img class="w-full" src={require('./assets/viveresenzalattosio-preview.webp')} alt="Anteprima viveresenzalattosio.it" className='object-cover h-64 w-full' />
                  <div class="p-4">
                    <h3 class="text-lg font-bold mb-2">Blog | Viveresenzalattosio.it (Owner)</h3>
                  </div>
                </div>
              </a>
            </div>
        ...
        <div className='container mx-auto'>
          <h2 class="text-3xl font-bold mb-2">Contatti</h2>
          <hr className="mb-2 h-[6px] bg-blue-400 w-32" />
          <div class="flex flex-wrap bg-gray-100 p-5 rounded-lg shadow">
            <div class="w-full md:w-1/2 px-4 mb-8">
              <h3 class="text-lg font-bold mb-2">Email</h3>
              <p class="text-gray-600">admin@msantoro.com</p>
            </div>

            <div class="w-full md:w-1/2 px-4 mb-8">
              <h3 class="text-lg font-bold mb-2">Telefono</h3>
              <p class="text-gray-600">+39 3337360501</p>
            </div>

            <div class="w-full md:w-1/2 px-4 mb-8">
              <h3 class="text-lg font-bold mb-2">Curriculum</h3>
              <a href={require('./assets/CV.pdf')} target="_blank" class="text-blue-500 hover:underline"><i class="fas fa-file-pdf mr-2"></i> Scarica il mio curriculum</a>
            </div>
            ...
            <div class="w-full md:w-1/2 px-4 mb-8">
              ...
              <ul class="list-none">
                <li class="mb-2">
                  <a href="https://github.com/MatthewSaintbull" target="_blank" class="text-blue-500 hover:underline flex items-center">
                    <i class="fab fa-github mr-2"></i>
                    Github
                  </a>
                </li>
                <li class="mb-2">
                  <a href="https://www.linkedin.com/in/matteo-santoro/" target="_blank" class="text-blue-500 hover:underline flex items-center">
                    <i class="fab fa-linkedin mr-2"></i>
                    LinkedIn
                  </a>
                </li>
                <li class="mb-2">
                  <a href="https://www.instagram.com/matteo_santoro_97/" target="_blank" class="text-blue-500 hover:underline flex items-center">
                    <i class="fab fa-instagram mr-2"></i>
                    Instagram
                  </a>
                </li>
                <li class="mb-2">
                  <a href="https://medium.com/@mttdev1997" target="_blank" class="text-blue-500 hover:underline flex items-center">
